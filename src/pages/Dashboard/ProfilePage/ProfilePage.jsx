...
const ProfilePage = () => {
  ...
  const users = {
    ...
    bio: `${user?.displayName || "Anonymous User"} is an experienced admin who manages the platform efficiently, oversees user activity, monitors content quality, and ensures smooth operation of all services. With a keen eye for detail and strong leadership skills, she maintains the platform’s integrity and user satisfaction.`,
  };
